...
I have a vault economy based plugin installed.
Plugin name : Orbis Factions
Version: 1.15.2
...
Oh for the wars only leaders can and once it happens there will be an announcement and will popup on the scoreboard (placeholder api) once factions are in war they can grief each other's claims (breaking blocks)
```
